...
builder.Services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
                .AddCookie(option =>
                {
                    option.Cookie.Name = "SGENERGY.Admin";
...
// Map thư mục ảnh vật lý dùng chung
var productImagesPath = app.Configuration["Storage:ProductImagesPath"];
...
SGENERGY.BusinessLayers.Configuration.Initialize(connectionString);
