...
namespace SGENERGY.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        /// <summary>
        /// Tìm kiếm đơn hàng và trả về kết quả dưới dạng phân trang
        /// </summary>
        /// <returns></returns>
        ...
        public IActionResult UpdateCartItem(int productId, int quantity, decimal salePrice)
        {
            ...
            if (quantity < 0)
            {
                return Json(new ApiResult(0, "Số lượng phải lớn hơn hoặc bằng 0"));
            }
        ...
        /// <summary>
        ///View để Cập nhật thông tin của mặt hàng trong đơn hàng 
        /// </summary>
        /// <param name="productId">Mã mặt hàng cần xử lý</param>
        /// <returns></returns>
