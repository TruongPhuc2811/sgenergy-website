...
namespace SGENERGY.Admin
{
    ...
    {
        /// <summary>
        /// Quản trị toàn bộ hệ thống, có quyền truy cập tất cả các chức năng
        /// </summary>
        public const string Administrator = "admin";  
        /// <summary>
        /// Quản lý dữ liệu (Mặt hàng, nhà cung cấp, loại hàng, người giao hàng)
        /// </summary>
        ...
        // Quản lý khách hàng
        public const string CustomerManager = "employee"; // lưu tạm vì database đang set role của nhân viên là "employee"
    }
