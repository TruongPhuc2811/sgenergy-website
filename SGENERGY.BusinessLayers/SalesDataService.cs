...
namespace SGENERGY.BusinessLayers
{
    ...
    public static class SalesDataService
    {
        ...
        /// <summary>
        /// Đơn hàng do khách hàng tự hủy (New/Accepted -> Cancelled)
        /// </summary>
        /// <param name="orderID"></param>
        /// <returns></returns>
        public static async Task<bool> CancelOrderByCustomerAsync(int orderID)
        {
            var order = await orderDB.GetAsync(orderID);
            if (order == null)
                return false;
        ...
        /// <summary>
        /// Hoàn tất đơn hàng (Accecpted/Shipping -> Completed)
        /// </summary>
        ...
        #region Order Detail
        /// <summary>
        /// Lấy danh sách chi tiết mặt hàng trong đơn hàng có mã OrderID
        /// </summary>
        /// <param name="orderID"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Lấy thông tin chi tiết của một mặt hàng trong đơn hàng theo OrderID và ProductID
        /// </summary>
        /// <param name="orderID"></param>
