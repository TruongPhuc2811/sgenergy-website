using SGENERGY.DomainModels.Security;
...
namespace SGENERGY.DataLayers.Interfaces
{
    ...
    public interface IUserAccountRepository
    {
        ...
        /// <summary>
        /// Đổi role của tài khoản
        /// </summary>
        /// <param name="userName"></param>
        /// <param name="roles"></param>
        /// <returns></returns>
        Task<bool> ChangeRoleAsync(string userName, string[] roles);
        /// <summary>
        /// Lấy role của tài khoản
        /// </summary>
        /// <param name="userName"></param>
        /// <returns></returns>
        Task<string> GetRoleNamesAsync(string userName);
    }
}
